                ...
                <div class="box box-danger">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box-header with-border bg-green-active" >
                            <h3 class="box-title">Recaudación </h3>
                        </div>
                        <div class="form-group">		
                            <div class="form-group">	
                                ...
                                <div class="col-lg-12">
                                    <div class="col-lg-3">
                                        <select class="form-control" name="t_identificacion" required="required" id="t_identificacion" onchange="validaselector()" readonly>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input type="text" class="form-control" maxlength="13" onkeypress="ValidaSoloNumeros()" placeholder="Identificación " required="required" name="identificacion" id="identificacion" readonly>

                                    </div>
                                    <div class="col-lg-4">	
                                        <!--label>Nombres y Apellidos:</label-->
                                        <input type="text" class="form-control"  placeholder="Nombres y Apellidos" name="nombres" id="nombres" readonly>
                                    </div>
                                    <div class="col-lg-2">
                                        <a href="#consulta"  id="listoModal" data-toggle="modal" class="btn btn-primary fa fa-search">Consulta</a>
                                    </div>
                                    <!--div class="col-lg-4">	
                                        <input type="text" class="form-control"  list="myCompanies" placeholder="Nombres y Apellidos" name="company" id="nombres">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" id="cartera" name="cartera" required="required" readonly>
                                    ...
                                    <div class="col-lg-4">	
                                        ...
                                        <input type="text" class="form-control" id="tip_cartera" placeholder="Tipo Cartera" readonly>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
