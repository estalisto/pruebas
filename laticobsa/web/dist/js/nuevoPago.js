...
function VistaPago(strRecaudacion){
    ...
    var accion = "visualizar";
      window.open("reportes?idRecaudacion=" + idRecaudacion + "&accion=" + accion, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=700,height=1000");
}
