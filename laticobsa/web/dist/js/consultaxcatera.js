...
document.getElementById("escogecliente").innerHTML="";
  var IdCliente=$("#cartera").val();
    ...
    var sqlQuery=" select '<a href=\"#\" onclick=\"GestionCliente('||s.id_cliente||','||s.id_datos_deudor||');\" >'||s.nombres_completo||'</a>' nombres_completo2,s.* from vw_consulta_cartera s  where s.id_cliente=IDClienteConsulta and s.id_empleado=IDEmpleadoConsulta and s.estado != 'E'";
