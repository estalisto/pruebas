<%@page import="com.laticobsa.utils.properties"%>
<%@page import="com.laticobsa.modelo.LcInstitucion"%>
<%@page import="com.laticobsa.modelo.LcFormapagoRecaudacion"%>
<%@page import="com.laticobsa.modelo.LcEmpleados"%>
<%@page import="com.laticobsa.servicios.EmpleadosServicios"%>
<%@page import="com.laticobsa.modelo.LcDatosDeudores"%>
<%@page import="com.laticobsa.servicios.RecaudacionServicios"%>
<%@page import="com.laticobsa.modelo.LcRecaudaciones"%>
<%@page import="com.laticobsa.utils.Numero_a_Letra"%>
...
<head>
 ...
 <!--link rel="icon" type="image/png" href="http://localhost:8080/laticobsa/dist/img/favicon.png"/-->
</head>
<body>
...
parameters.put("rutaimg", rutaimg); ////[001] JG.  
