             ...
             <form name="form" action="recepcion" method="post" class="well">
                 ...
                 <div class="row form-group">
                     ...
                     <label>Ticket: </label>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control input-sm" id="ticket" name="ticket" readonly="true">
                 ...
                 <div class="row form-group">
                     ...
                     <label>ID Deudor: </label>
                       ...
                       <div class="col-sm-4">
                            <input type="text" class=" form-control input-sm" id="id_deudor" name="id_deudor" readonly="true"> 
                        </div>
                     <div class="col-sm-2">
                         <label>Cofirmación Recepción: </label>
                     </div>
                     <div class="col-sm-2">                        
                         <input type="checkbox" href="#data_recepcion" name="recepcionSI" id="recepcionSI" onclick="DatosRecibidos()" class="btn btn-success" data-toggle="modal" ><b style="color:#00ca6d">SI</b><br>

                     </div>
                     <div class="col-sm-2">                        
                         <input type="checkbox" href="#data_recepcion" name="recepcionNO" id="recepcionNO" onclick="DatosRecibidos()" class="btn btn-success" data-toggle="modal"><b style="color:#00ca6d">NO</b><br>
                   ...
                   <div class="row form-group">
                     ...
                     <label>Identificación: </label>
                       ...
                       <div class="col-sm-4">
                            <input type="text" class=" form-control input-sm" id="identificacion" name="identificacion" readonly="true"> 
                        </div>
                       <div class="col-sm-2">
                     <label>Nombres Completos: </label>
                     </div>
                       <div class="col-sm-4">
                            <input type="text" class=" form-control input-sm" id="nombres" name="nombres" readonly="true"> 
                        </div>
                 </div>
            ...
            <div class="modal-content">
                <br><div class="box box-danger">
                    ...
                    <div id="id_message" class="form-group has-error" style="display: none"> 
                        <br>&nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="help-block">     Falta un Dato de ingreso</span>
                    </div>
