                ...
                <div class="panel panel-default well margin">
                    ...
                    <c:forEach items="${cobranzas}" var="cobro">
                                    ...
                                    <c:if test="${!empty(notas)}">
                                        ...
                                        <c:forEach items="${notas}" var="nota">
                                            <input id="idNotas" type="text" class="form-control hidden" placeholder="Dirección Trabajo" name="act_trabajo" value="<c:out value="${nota.getIdNota()}" />" >
                                               ...
                                               <textarea maxlength="500" id="txtnota" class="form-control input-sm " rows="3" onkeyup="ValidarNota2()"  placeholder="NOTAS" style="overflow-y:scroll; background-color:#FDF9DB;" value="<c:out value="${nota.getIdNota()}"/>"><c:out value="${nota.getObservacion()}"/></textarea>
                                        </c:forEach> 
                                    </c:if>
                                      <c:if test="${empty(notas)}">
                                          <input id="idNotas" type="text" class="form-control hidden" placeholder="Dirección Trabajo" name="act_trabajo" value="0" />
                                           ...
                                           <textarea maxlength="500" id="txtnota" class="form-control input-sm "  rows="3" onkeyup="ValidarNota2()"  placeholder="NOTAS" style="overflow-y:scroll;background-color:#FDF9DB;" ></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="row"> 
                                <div class="col-sm-11">
                                     <strong> <textarea maxlength="600" class="form-control input-sm" id="descripcion" name="descripcion" rows="2" placeholder="Descripción" style="overflow-y:scroll; background-color:#FDF9DB;"></textarea>   </strong>
                                </div>
                                <div class="col-sm-1">
