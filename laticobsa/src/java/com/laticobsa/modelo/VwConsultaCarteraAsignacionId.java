...
/**
 * VwConsultaCarteraAsignacionId generated by hbm2java
 */
public class VwConsultaCarteraAsignacionId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VwConsultaCarteraAsignacionId) ) return false;
		 VwConsultaCarteraAsignacionId castOther = ( VwConsultaCarteraAsignacionId ) other; 
