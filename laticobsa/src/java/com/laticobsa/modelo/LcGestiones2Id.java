...
/**
 * LcGestiones2Id generated by hbm2java
 */
public class LcGestiones2Id  implements java.io.Serializable {
    ...
    public LcGestiones2Id() {
    }

    public LcGestiones2Id(String cartera, String identificacion, String nombreDeudor, BigDecimal operacion, Date fecha, String gestor, Byte resultado, String detalleGestion, Integer idGestor) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LcGestiones2Id) ) return false;
		 LcGestiones2Id castOther = ( LcGestiones2Id ) other; 
 ...
 && ( (this.getIdGestor()==castOther.getIdGestor()) || ( this.getIdGestor()!=null && castOther.getIdGestor()!=null && this.getIdGestor().equals(castOther.getIdGestor()) ) );
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getIdGestor() == null ? 0 : this.getIdGestor().hashCode() );
         return result;
   }   
