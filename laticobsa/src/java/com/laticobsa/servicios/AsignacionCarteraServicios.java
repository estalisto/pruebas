...
import com.laticobsa.modelo.LcAsignaEmpleadosTmp;
import com.laticobsa.modelo.LcCartera;
...
import com.laticobsa.modelo.LcSegmento;
import com.laticobsa.modelo.LcSubcartera;
import com.laticobsa.modelo.LcSubsegmento;
    ...
    public String getRegistraTransTem(int secuencia, int cartera){
        String valor = "";
         try{      
            ...
            PreparedStatement pst;
            ResultSet rs;
            pst = conexion.getconexion().prepareStatement("select  fnc_ejecuta_setencia("+secuencia+","+cartera+");");
            rs = pst.executeQuery();
            while(rs.next())    //Mientras haya una sig. tupla
            {
                valor=rs.getString(1);
